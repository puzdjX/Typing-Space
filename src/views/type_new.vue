                ...
                <div class="box type">
                    <div class="title">
                        <div class="time-countdown">
                            <svg xmlns="https://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-alarm"
                                width="50" height="50" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor"
                    ...
                    <div class="type-game">
                        <div class="type-pro">
                            <div class="text"
                                ...
                                <input :ref="'areaDom' + index" type="input" :maxlength="input_lim + 1" class="new_type"
